...
const { checkHandeler } = require('./handelers/routeHandelers/checkHandeler'); // Importing the 'sampleHandeler' function from the './handelers/routeHandelers/sampleHandeler' module
